# Enable Powerlevel10k instant prompt. Should stay close to the top of /tmp/root-code-zsh/.zshrc.
...
# To customize prompt, run `p10k configure` or edit /workspaces/terraform/.devcontainer/.p10k.zsh.
